...
def main_run(dataset, flowModel, rgbModel, stackSize, seqLen, memSize, variant, trainDatasetDir, valDatasetDir, outDir,
    ...
    model_folder = os.path.join('./', outDir, dataset, 'twoStream+cwa')  # Dir for saving models and log files
    # Create the dir
    ...
    model = twoStreamAttentionModel(variant, flowModel=flowModel, frameModel=rgbModel, stackSize=stackSize,
                                    memSize=memSize,
...
def __main__():
    ...
    main_run(dataset, flowModel, rgbModel, stackSize, seqLen, memSize, variant, trainDatasetDir, valDatasetDir, outDir,
             trainBatchSize, valBatchSize, lr1, numEpochs, decay_step, decay_factor)
